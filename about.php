            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="about__pic">
                        <img src="img/about/aboutMain.jpg" alt="">
                    </div>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="team__item">
                        <img src="img/about/Kartik-Gulati.jpg" alt="">
                        <h4>Kartik Gulati</h4>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="team__item">
                        <img src="img/about/Pooja-Gandhi.jpg" alt="">
                        <h4>Pooja Gandhi</h4>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="team__item">
                        <img src="img/about/Nipul-Haldar.jpg" alt="">
                        <h4>Nipul Haldar</h4>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="team__item">
                        <img src="img/about/Dimple Thawani.jpg" alt="">
                        <h4>Dimple Thawani</h4>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="team__item">
                        <img src="img/about/Dhiraj-Wadhwani.jpg" alt="">
                        <h4>Dhiraj Wadhwani</h4>
                    </div>
                </div>
            </div>
        </div>
