                    ...
                    <!-- <div class="col mb-5">
                        ...
                        <?php
                            while($row = mysqli_fetch_array($result, MYSQLI_ASSOC)){ 
                                ...
                                <div class='text-center'><a class='btn btn-outline-success mt-auto' href='update_stories.php?id={$row['id']}'>Edit Story</a><br><br><a class='btn btn-outline-danger  mt-auto' href='delete_stories.php?id={$row['id']}'>Delete</a></div></div></div></div>";
