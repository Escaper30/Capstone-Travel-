...
if(isset($_POST["ad_submit"])){
  $result = $admin_login->adminlogin($_POST["ad_email"], $_POST["ad_password"]);

  if($result == 1){
    $_SESSION["adminlogin"] = true;
    $_SESSION["ad_id"] = $admin_login->idAdmin();
                ...
                <form action="" method="post" autocomplete="off">
                    <div class="row">
                        <div class="col-lg-8 col-md-6">
                            ...
                            <h5 class="checkout__title">Login </h5>
                    ...
                    <button type="submit" name="ad_submit" class="primary-btn">Submit<span class="arrow_right"></span></button> 
                </form>
            </div>
        </div>
    </section>
